...
export default function JobCard({
  ...
  return (
    <Card
      ...
      key={job.id}
      className={cn(
        "p-3 md:p-4 border border-neutral-40 rounded-lg cursor-pointer transition-all hover:border-primary hover:shadow-md gap-1 mb-3",
        selected
          ? "border-primary bg-primary-surface border-2"
          : "bg-neutral-10"
      )}
    >
      <div className="flex items-center gap-2 md:gap-3 border-b border-dashed border-neutral-40 pb-1">
        <Image
